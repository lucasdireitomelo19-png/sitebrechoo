...
export function WhatsappIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M4 20l1.3-3.9A8 8 0 1 1 8.9 19L4 20Z" strokeLinejoin="round" />
      <path d="M8.5 9.5c.3 2.3 2.7 4.7 5 5 .9.1 1.5-.5 1.9-1.2.1-.2 0-.5-.2-.6l-1.7-.9c-.2-.1-.4-.1-.6.1l-.4.5c-1-.5-1.9-1.4-2.4-2.4l.5-.4c.2-.2.2-.4.1-.6l-.9-1.7c-.1-.2-.4-.3-.6-.2-.7.4-1.3 1-1.2 1.9-.1 0-.1 0-.1.1" />
    </svg>
  );
}
